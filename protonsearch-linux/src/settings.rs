...
pub fn catalogue() -> Vec<LinuxSettingItem> {
    vec![
        ...
        LinuxSettingItem {
            id: "launcher.startup",
            name: "Run at login",
            description: "Enable or disable the ProtonSearch systemd user service",
            action: "settings",
        },
        LinuxSettingItem {
            id: "launcher.focus",
            name: "Hide on focus loss",
            description: "Hide the launcher when another window becomes active",
            action: "settings",
        },
        LinuxSettingItem {
            id: "launcher.appearance",
            name: "Launcher appearance",
            description: "Choose GTK theme and launcher dimensions",
            action: "settings",
        },
        LinuxSettingItem {
            id: "search.terminal-apps",
            name: "Terminal applications",
            description: "Include or exclude Terminal=true desktop applications",
            action: "settings",
        },
        LinuxSettingItem {
            id: "providers.calculator",
            name: "Calculator provider",
            description: "Enable calculator results in the launcher",
            action: "settings",
        },
        LinuxSettingItem {
            id: "providers.git",
            name: "Git commit provider",
            description: "Enable bounded Git commit discovery",
            action: "settings",
        },
        LinuxSettingItem {
            id: "providers.clipboard",
            name: "Clipboard provider",
            description: "Enable clipboard history and image previews",
            action: "settings",
        },
        LinuxSettingItem {
            id: "providers.ocr",
        ...
        LinuxSettingItem {
            id: "providers.browser-history",
            name: "Browser history provider",
            description: "Enable readable browser history searches",
            action: "settings",
        },
        LinuxSettingItem {
            id: "safety.power-confirmation",
            name: "Power-action confirmation",
            description: "Keep a confirmation step before power and session actions",
            action: "settings",
        },
        LinuxSettingItem {
            id: "apps.desktop",
