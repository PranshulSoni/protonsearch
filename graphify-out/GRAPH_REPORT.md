...
## Corpus Check
- 11 files · ~50,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 105 nodes · 173 edges · 14 communities detected
...
3. `trigger_icon_loading()` - 6 edges
4. `run_browser_indexer()` - 5 edges
...
- `wnd_proc()` --calls--> `paint()`  [EXTRACTED]
  opensearch-os\src\main.rs → opensearch-os\src\main.rs  _Bridges community 2 → community 6_
...
Cohesion: 0.52
Nodes (6): get_browser_profiles(), parse_bookmarks(), parse_history(), run_browser_indexer(), start_browser_indexer(), traverse_bookmarks()
...
- **Why does `wnd_proc()` connect `Community 2` to `Community 1`, `Community 6`?**
